...
const String baseUrl = String.fromEnvironment(
  'API_BASE_URL',
  defaultValue: 'https://backendserverflutter3.onrender.com/api/',
);
...
abstract class ApiConfig {
  ...
  Future<dynamic> sendRequest({
    ...
    return RequestHandler.call(
      getUrlString(urlParam: urlParam),
      method,
      authorized: isAuth,
      body: body,
...
class RequestHandler {
  static Future<dynamic> call(
    ...
    try {
      ...
      final response = await method.apiCall(
        Uri.parse(urlString),
        headers: headers,
      ...
      if (response.statusCode == 200) {
        ...
        return result;
      } else if (json.decode(utf8.decode(response.bodyBytes))['message'] !=
          null) {
