...
import 'package:jobfe/features/partner_jobs/partner_card.dart';
...
class _PartnersCarouselState extends State<PartnersCarousel> {
  ...
  getSpotlightCompanies(int size, int page) async {
    companyList = await CompanyApi.getContractCompany.sendRequest(
        ...
        Container(
          ...
          child: Column(
            children: [
              ...
              CarouselSlider(
                items:
                    companyList.map((item) => PartnerCard(item: item)).toList(),
