...
import 'package:jobfe/screens/companies/companies_screen.dart';
import 'package:jobfe/screens/jobs/jobs_screen.dart';
import 'package:jobfe/screens/my_jobs/my_jobs_screen.dart';
import 'package:jobfe/screens/profile/profile_screen.dart';
import 'package:jobfe/screens/search/search_screen.dart';
import 'package:jobfe/screens/tools/my_follow_company_screen.dart';
import 'package:jobfe/screens/tools/tools_screen.dart';
...
class _TabsScreenState extends ConsumerState<TabsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar:
          _selectPageIndex == 4 || _selectPageIndex == 2
              ? null
              : AppBar(
                  ...
                  IconButton(
                    onPressed: () async {
                      ...
                      if (userToken == null) {
                        ...
                        Navigator.of(context).push(
                          MaterialPageRoute(
                            builder: (ctx) => const MyFollowCompanyScreen(),
                          ),
                        );
                      }
                    },
