...
import 'package:jobfe/screens/my_cv/cv_form_screen.dart';
import 'package:jobfe/screens/pdf_view_screen.dart';
...
class _MyCVScreenState extends State<MyCVScreen> {
  ...
  deleteCV(int id) async {
    String? userToken = await storage.read(key: 'token');
    await CandidateCVApi.deleteCV.sendRequest(
      token: userToken,
      urlParam: '?id=$id',
    );
    getAllCV(10, 1);
                  ...
                  showModalBottomSheet(
                    ...
                    builder: (BuildContext context) {
                      ...
                      return StatefulBuilder(
                        builder:
                            (BuildContext context, setState) => Container(
                              width: double.infinity,
                              ...
                              child: Column(
                                children: [
                                  ...
                                  ElevatedButton(
                                    onPressed: () async {
                                      final isValid =
                                          _formCVName.currentState?.validate();
                                      if (!isValid!) {
                                        return;
                                      }
              ...
              ElevatedButton(
                onPressed: () {
                  Navigator.of(context)
                      .push(
                        MaterialPageRoute(
                          builder: (ctx) => const CvFormScreen(),
                        ),
                      )
                      .then((value) => getAllCV(10, 1));
                },
                                          ...
                                          showDialog(
                                            ...
                                            builder:
                                                (
                                                  ...
                                                  content: Text(
                                                    'Are you sure to delete CV ${cvList[index]['name'].toString().toUpperCase()}',
                                                    textAlign: TextAlign.center,
                                                  ),
                                                  actions: [
                                                    TextButton(
