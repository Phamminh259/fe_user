...
import 'package:jobfe/screens/about_screen.dart';
import 'package:jobfe/screens/auth/login_screen.dart';
import 'package:jobfe/screens/privacy_policy_screen.dart';
import 'package:jobfe/screens/term_condition_screen.dart';
                        ...
                        child: TextButton(
                          ...
                          onPressed: () {
                            Navigator.of(context).push(
                              MaterialPageRoute(
                                builder:
                                    (ctx) => const LoginScreen(tabIndex: 0),
                              ),
                            );
                          },
                        ),
                                  ...
                                  builder: (BuildContext context) {
                                    uploadFile(
                                      ...
                                      var request = http.MultipartRequest(
                                        'PUT',
                                        Uri.parse(
                                          'http://10.0.2.2:8080/api/general/account',
                                        ),
                                      );
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton.icon(
                          ...
                          onPressed: () {
                            Navigator.of(context).push(
                              MaterialPageRoute(
                                builder: (ctx) => const TermConditionScreen(),
                              ),
                            );
                          },
                        ),
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton.icon(
                          ...
                          label: const Text('TOP VIEC LAM Fanpage'),
                          onPressed: () async {
                            try {
                              await launchUrl(
                          ...
                          onPressed: () async {
                            ...
                            final Uri launchUri = Uri(
                              ...
                              query: encodeQueryParameters(<String, String>{
                                'subject':
                                    'Hello TOP VIEC LAM, I have question',
                              }),
                            );
                            await launchUrl(launchUri);
                          },
